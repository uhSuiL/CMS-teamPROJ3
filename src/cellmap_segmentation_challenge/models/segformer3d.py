...
class SegFormer3D(nn.Module):
    ...
    def _init_segmentation_head(self):
        nn.init.trunc_normal_(self.segformer_decoder.linear_pred.weight, std=0.02)
        if self.segformer_decoder.linear_pred.bias is not None:
            nn.init.constant_(self.segformer_decoder.linear_pred.bias, 0)
